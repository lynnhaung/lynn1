...
*/
$query = "select * from TOEFL_IS_600 where id = '$a' AND lala_incorrect > lala_correct " or die("Error in the consult.." . mysqli_error($conn)); 
...
<fieldset>
<legend>選擇答案</legend>
<input type="button" value="<?php echo "(A)$ca"; ?>" onClick="this.form.action='quiz_600.php';this.form.submit();"> 
<input type="hidden" value="<?php echo $a; ?>" name="ans" >
</form>
<br>
<br>
<form method="get"> 
<input type="button" value="<?php echo "(B)$cb"; ?>" onClick="this.form.action='quiz_600.php';this.form.submit();"> 
<input type="hidden" value="<?php echo $b; ?>" name="ans" >
</form>

<form method="get"> 
<input type="button" value="<?php echo "(C)$cc"; ?>" onClick="this.form.action='quiz_600.php';this.form.submit();"> 
<input type="hidden" value="<?php echo $c; ?>" name="ans" >
</form>

<form method="get"> 
<input type="button" value="<?php echo "(D)$cd"; ?>" onClick="this.form.action='quiz_600.php';this.form.submit();"> 
...
if($_GET[ans] == $cor)
{
	...
	$sql = "insert into quiz_600_record (master_id, english, correct_time, error_time, time, member) values ( '".$cor."','".$core."', '',  '', now(), '".$id."'  )"or die("Error in the consult.." . mysqli_error($conn)); 
	$result = $conn->query($sql);
